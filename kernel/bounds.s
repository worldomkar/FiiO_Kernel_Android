...
@ kernel/bounds.c -mlittle-endian -mcpu=cortex-a9 -march=armv7-a
@ -mtune=cortex-a9 -mfpu=vfpv3 -mfloat-abi=softfp -marm -mabi=aapcs-linux
...
@ -Wno-unused -Wframe-larger-than=1024 -Wno-unused-but-set-variable
